...
from app.features.failsafe.schemas import FailsafeResponse, SetupCheckResponse, SidebarUnlockResponse
...
@router.get("/sidebar/unlock", response_model=SidebarUnlockResponse)
